...
export default function InspectionsScreen() {
    ...
    const tasks = [
        ...
        },
        {
            ...
            subtitle: 'Verified Batch BTCH-8840',
            icon: 'document-text',
            color: '#3B82F6',
            route: '/batch-cert',
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]} edges={[]}>
            ...
            <SafeMeatHeader title="Inspection Tasks" role={role as string} />
            ...
            >
                ...
                <View style={styles.heroSection}>
                    <Text style={[styles.welcomeText, { color: theme.text }]}>Operations Hub</Text>
                    <Text style={[styles.subtitleText, { color: theme.muted }]}>Daily Inspection Management</Text>
                ...
                <View style={styles.sectionHeader}>
                    <Text style={[styles.sectionTitle, { color: theme.text }]}>Current Workflow</Text>
                    <View style={[styles.sectionBadge, { backgroundColor: theme.primary + '18' }]}>
                        <Text style={[styles.sectionBadgeText, { color: theme.primary }]}>{tasks.length} pending</Text>
                    </View>
                </View>
                    ...
                    >
                        <SafeMeatCard style={styles.taskCard}>
                            ...
                            <View style={styles.taskInfo}>
                                ...
                                <Text style={[styles.taskSubtitle, { color: theme.muted }]}>{task.subtitle}</Text>
                                <View style={[styles.statusBadge, {
                                    backgroundColor: task.status === 'READY' ? '#10B98120' :
                                        task.status === 'PENDING' ? '#F59E0B20' : '#EF444420',
                                    marginTop: 6,
                                    alignSelf: 'flex-start'
                                }]}>
                                    <Text style={[styles.statusText, {
                                        color: task.status === 'READY' ? '#10B981' :
